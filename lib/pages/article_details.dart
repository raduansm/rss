                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    ...
                                    Spacer(),
                                    IconButton(
                                        icon: BuildLoveIcon(collectionName: 'contents', uid: sb.uid, timestamp: article.timestamp),
                                        onPressed: () {
                                          handleLoveClick();
                                        }),
                                    IconButton(
                                        icon: BuildBookmarkIcon(collectionName: 'contents', uid: sb.uid, timestamp: article.timestamp),
                                        onPressed: () {
                                          handleBookmarkClick();
                                        }),
                                  ],
                                ...
                                Text(
                                  article.title!,
                                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: -0.6, wordSpacing: 1),
                                ),
                                Divider(
                                ...
                                Center(
                                  child: TextButton.icon(
                                    ...
                                    icon: Icon(Feather.external_link, color: Colors.white, size: 20),
                                    label: Text('Source', style: TextStyle(color: Colors.white)).tr(),
                                    onPressed: () {
                                      print(article.sourceUrl);
                                      AppService().openLinkWithCustomTab(context, article.sourceUrl!);
                                    },
                                  ),
                                ),
                                SizedBox(
